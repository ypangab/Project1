...
from keras.layers import Embedding, Dense, Dropout, LSTM, SimpleRNN, GRU,  Conv1D, GlobalMaxPooling1D, Bidirectional, Flatten, MaxPooling1D
...
if __name__ == '__main__':
    ...
    model.add(Bidirectional(LSTM(units=hidden_size, dropout=dropout_rate, recurrent_dropout=dropout_rate,
    ...
    #training
    model.fit(train_data_matrix, train_data_label, validation_data=(valid_data_matrix, valid_data_label), epochs=total_epoch, batch_size=batch_size)
    # testing
    ...
    #Save model
    #Save model
    sentEncoder.save('GB_model.h5')
    model.save('GB_model.h5')
